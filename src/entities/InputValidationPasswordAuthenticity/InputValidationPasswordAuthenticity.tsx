...
interface InputValidationPasswordAuthenticityProps {
  type: string;
  placeholder: string;
  inputName: string;
...
const InputValidationPasswordAuthenticity: FC<
  InputValidationPasswordAuthenticityProps
> = ({
  type,
  placeholder,
  showPassword,
...
export default InputValidationPasswordAuthenticity;
